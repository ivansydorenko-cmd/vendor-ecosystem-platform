#!/bin/bash
echo "🗄️ Creating database migration and seed files..."

cat > database/migrations/001_initial_schema.sql << 'SQLMIGRATION'
...
cat > database/seeds/001_initial_data.sql << 'SQLSEED'
-- Initial seed data
